...
export const accessToken = (params: requestTokenBody ): Promise<APIResponse<AuthResponse>> => 
	http.POST<AuthResponse>(GET_ACCESS_TOKEN_V4, params); 

	export const deleteToken = (params: requestTokenBody ): Promise<APIResponse<AuthResponse>> => 
